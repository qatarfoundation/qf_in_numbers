// Vendor
import { AdditiveBlending, Color, LinearFilter, MeshBasicMaterial, RGBAFormat, ShaderMaterial, UniformsUtils, Vector2, Vector3, WebGLRenderTarget, RawShaderMaterial } from 'three';
...
// import bloomOverrideVertexShader from '@/webgl/shaders/bloom-override/vertex.glsl';
// import bloomOverrideFragmentShader from '@/webgl/shaders/bloom-override/fragment.glsl';
// import textureVertexShader from '@/webgl/shaders/texture/vertex.glsl';
// import textureFragmentShader from '@/webgl/shaders/texture/fragment.glsl';
...
class CustomUnrealBloomPass extends Pass {
    ...
    _createMaterialOverride() {
        const material = new RawShaderMaterial({
            vertexShader: bloomOverrideVertexShader,
            fragmentShader: bloomOverrideFragmentShader,
        });
        return material;
    }
